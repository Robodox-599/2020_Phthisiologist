...
void subsystem_Intake::SetIntakeWheelsOn(double positivePower, double negativePower)
{
    m_intakeMotor.Set(ControlMode::PercentOutput, positivePower-negativePower);
}
