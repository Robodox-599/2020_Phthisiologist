...
command_AimBotAutoAim::command_AimBotAutoAim(subsystem_AimBot* aimBot, subsystem_Drive* drive) : m_aimBot{aimBot}, m_drive{drive} {
...
void command_AimBotAutoAim::Initialize() 
{
  timer.Stop();
  timer.Reset();
  linedUp = false;
...
void command_AimBotAutoAim::Execute() 
{
